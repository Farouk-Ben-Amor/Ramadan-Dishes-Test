...
const cookingController = {
  getCookingRoutes: async (req, res) => {
    try {
      ...
      let validationDayMessage = validateDay(day);
      ...
      let validationIngredientMessage = validateIngredient(ingredient, dishes);
      ...
      let formattedDate = `-----> Today is ${StartDate.format(
        "MM/DD"
      ...
      let maghribTime = moment(dayPrayerTimes.timings.Maghrib, "HH:mm");
